---
title: Dynamic vs Static Legacy Registration
description: "Architectural decision: why freeze manifests over static model definitions"
---

# Dynamic vs Static Legacy Registration

[[Home]] / [[Migration Workflow Overview]] / Dynamic vs Static Legacy Registration

---

## The Decision

For this migration architecture, **dynamic registration with a freeze manifest** is the correct mechanism — not static read-only model definitions.

> [!important]
> This is an architectural decision, not a convenience preference. The reasons are explained below.
...
Developers would:
- Define explicit Django model classes for each legacy table
- Wire serializers and admin entries manually
- Deploy code changes whenever the legacy table set changes

This **appears simpler** at first. But it breaks down at scale.
...
<details>
<summary><strong>Schema layer problems</strong></summary>
...
- **Static registration inflates startup coupling.** Every static model must be import-safe at startup. If one references non-existent metadata, bootstrapping fails.

</details>

<details>
<summary><strong>Permissions layer problems</strong></summary>
...
<details>
<summary><strong>Release layer problems</strong></summary>
...
<details>
<summary><strong>Data integrity problems</strong></summary>
...
*See also: [[Migration Workflow Overview]] | [[steps/Step 8 — Final Freeze Manifest|Step 8]]*
