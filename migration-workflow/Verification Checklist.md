...
description: Post-run health checks for the migration workflow
---

# Verification Checklist

[[Home]] / [[Migration Workflow Overview]] / Verification Checklist
...
| `.lex_legacy_freeze_manifest.pre_migrate.json` | ⚙️ Only with `--enable-sanitization` |
| `.lex_migration_state_before.json` | ⚙️ Only with `--rollback-on-failure` |

---

*See also: [[Migration Workflow Overview]] | [[Example Commands]]*
