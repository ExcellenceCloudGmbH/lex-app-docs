...
description: CLI modes, flags, and defaults for the migration workflow
---

# Invocation Modes & Flags

[[Home]] / [[Migration Workflow Overview]] / Invocation Modes
...
### Mode B — V2 Project + DB Name (In-Place Mode)
...
### Mode C — DB Name Only (Local Mode)
...
*See also: [[Example Commands]] | [[Migration Workflow Overview]]*
