...
aliases:
  - "features/processing/batch calculations"
---
...
For large batches, you can tell the framework how to **group** models for parallel execution on [[calculations/celery and async calculations|Celery workers]]:
...
> [!note]
> Parallel dispatch requires `CELERY_ACTIVE=true` in your environment. Without it, all groups are processed synchronously in sequence. See [[calculations/celery and async calculations]] for the full Celery setup.
