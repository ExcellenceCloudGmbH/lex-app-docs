...
See [[start-here/installation]] for how to configure it.
...
> [!tip]
> To organize models in the frontend sidebar, use a `model_structure.yaml` file. See [[model-your-data/model structure]] for details.
