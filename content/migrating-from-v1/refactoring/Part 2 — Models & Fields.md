...
aliases:
  - "migration/refactoring/Part 2 — Models & Fields"
---
...
| `UploadModelMixin` | `LexModel` + `@hook` | Models that process on create (covered in [[migrating-from-v1/refactoring/Part 4 — Lifecycle Hooks\|Part 4]]) |
| `ConditionalUpdateMixin` | `CalculationModel` | Models with a calculate button (covered in [[migrating-from-v1/refactoring/Part 3 — Calculations\|Part 3]]) |
...
- [ ] Calculation models inherit from `CalculationModel` (conversion in [[migrating-from-v1/refactoring/Part 3 — Calculations|Part 3]])
...
Next: [[migrating-from-v1/refactoring/Part 3 — Calculations|Part 3 — Calculations]].
