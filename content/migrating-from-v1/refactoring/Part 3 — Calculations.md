...
aliases:
  - "migration/refactoring/Part 3 — Calculations"
---
...
> [!tip]
> You can still add custom error handling if you want to log specific messages via [[calculations/logging|LexLogger]] before the exception propagates.
...
- [ ] Logging calls updated from `CalculationLog` to `LexLogger` (detail in [[migrating-from-v1/refactoring/Part 5 — Logging & Permissions|Part 5]])

Next: [[migrating-from-v1/refactoring/Part 4 — Lifecycle Hooks|Part 4 — Lifecycle Hooks]].
