...
title: Summary Tab
aliases:
  - "interface/record-detail/summary tab"
---
...
Your developer defines these presets via [[model-your-data/serializers|serializers]]. As a user, you just pick the view that fits your task.
...
Click the **Edit** button in the toolbar to switch to the edit form. All editable fields become input fields — text boxes, dropdowns, date pickers — pre-populated with the current values. Fields you don't have [[access-and-dashboards/permissions|permission]] to modify appear as read-only.
