...
title: Analytics Tab
aliases:
  - "interface/record-detail/analytics tab"
---
...
|---|---|---|
| **Table-level** | Overview metrics for the entire model (all records) | [[using-the-app/the-grid/index\|The Grid]] toolbar or sidebar |
