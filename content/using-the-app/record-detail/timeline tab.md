...
title: Timeline Tab
aliases:
  - "interface/record-detail/timeline tab"
---
...
This is where Lex App's [[history-and-audit/bitemporal history|bitemporal model]] comes to life. The timeline can show changes along two independent dimensions:
...
Below the timeline, the **Audit Feed** shows a chronological list of API operations that affected this record — create, update, delete events captured by the [[history-and-audit/audit logs|audit log system]]. Each entry shows the author, timestamp, operation type, and status.
...
> [!tip]
> For full audit log details with payloads and error tracebacks, switch to the dedicated [[using-the-app/record-detail/audit log tab|Audit Log tab]].
