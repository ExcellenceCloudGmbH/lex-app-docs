...
title: Serializers
aliases:
  - "features/data-pipeline/serializers"
---
...
1. **`@add_permission_checks`** — integrates with the [[access-and-dashboards/permissions|permission system]], enforcing `permission_read()` and `permission_edit()` at the API level
