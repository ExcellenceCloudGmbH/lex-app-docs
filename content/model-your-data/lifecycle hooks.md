...
aliases:
  - "features/data-pipeline/lifecycle hooks"
---
...
| Use Case | Pattern |
|---|---|
| User-initiated, long-running calculation with progress tracking | [[calculations/calculation models\|CalculationModel]] + `calculate()` |
