...
Embed Lex App screens inside Streamlit and react to user actions like create, update, select, and navigation events directly in Python. Useful for guided multi-step workflows and Streamlit-driven control panels.
