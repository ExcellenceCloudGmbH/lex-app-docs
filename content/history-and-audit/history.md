...
See [[model-your-data/model structure|Model Structure]] for details.
...
Consider a backdated salary correction entered on March 15th but effective since January 1st. A single-dimension history can't represent both dates on the same row. That's the problem that [[history-and-audit/bitemporal history|Bitemporal History]] solves by adding a second layer — MetaHistory — that tracks system time independently.
