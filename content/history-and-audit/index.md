...
### [[history-and-audit/history|History (Simple History)]]
...
### [[history-and-audit/bitemporal history|Bitemporal History]]
...
### [[history-and-audit/audit logs|Audit Logs]]
...
|---|---|
| "What did record #42 look like last week?" | **[[history-and-audit/history\|History]]** — full field snapshot at any version |
| "Who deleted record #42?" | **[[history-and-audit/audit logs\|Audit Logs]]** — author, action, timestamp |
| "Did the API call succeed or fail?" | **[[history-and-audit/audit logs\|Audit Logs]]** — status + error traceback |
| "What did we *think* was true on March 1st?" | **[[history-and-audit/bitemporal history\|Bitemporal History]]** — system time query |
| "What was *actually* correct on March 1st?" | **[[history-and-audit/bitemporal history\|Bitemporal History]]** — valid time query |
