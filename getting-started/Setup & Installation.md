...
description: Install LEX, configure your environment, and run your first initialization
---

# Setup & Installation

[[Home]] / [[Getting Started]] / Setup & Installation

---

## Step 1: Install the LEX Framework

Install the `lex-app` package. This gives you the `lex` CLI tool.
...
Run `lex setup` and follow the prompts. The wizard will:
1. Open [excellence-cloud.de](https://excellence-cloud.de) for you
2. Guide you through creating a new Client
3. Auto-populate your `.env` file
...
<details>
<summary>🖥️ Windows (PowerShell)</summary>
